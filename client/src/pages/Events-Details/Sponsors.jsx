    ...
    <div className=' bg-amber-100 pb-20'>
      <div className="flex flex-row ">
        {/* <div className="w-[50%] max-xs:w-full ml-24 max-xxs:ml-2 max-xs:ml-4 max-md:ml-10 max-lg:ml-12 max-xl:ml-16 py-20 max-xxs:py-0 max-xs:py-2 max-md:py-10 max-lg:py-14 mt-8 max-xxs:mt-2 max-xs:mt-4 max-lg:mt-6"> */}
            <div className="flex flex-col ml-24 text-orange-400 max-xs:flex-row font-bold text-6xl max-xxs:text-xl py-10 max-sm:text-2xl max-md:text-3xl max-lg:text-4xl max-xl:text-5xl mt-8">
                <p>Our Sponsors</p>
