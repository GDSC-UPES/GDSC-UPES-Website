    ...
    <div>
      <div className='bg-lineColor border-solid w-full h-[1.5px]'><hr></hr></div>
        ...
        <div className="flex flex-col w-[20%]">
          ...
          alt="Event Logo"
          className='w-[50%] mt-40 ml-20'
          />
          </div>
          <div className="flex flex-col w-[50%] p-4 mt-40">
          <p className='flex leading-normal text-5xl font-bold text-black mt-10 '>{CurrentEventData[0].title}</p>
          <button className='border-2 rounded-full h-10 w-40 border-blue-600 text-blue-600 font-semibold mt-10 '>{CurrentEventData[0].type}</button>
          <p className='text-2xl font-semibold mt-10'>{CurrentEventData[0].desc}</p>
          <div className="flex">
            <Link to="">
          ...
          <div className="flex flex-row items-center justify-center">
          <div className=" flex flex-row box-border rounded-lg p-5 w-[60%] h-55 bg-orange-100 mt-20">
            ...
            className='h-20 w-20'
            />
            <p className='text-greyText text-4xl font-bold mt-2 '>{CurrentEventData[0].date}</p>
            ...
            className='h-30 w-20'
            />
            <p className='text-greyText text-3xl font-bold '>{CurrentEventData[0].time}</p>
            </div>
            <div className="flex flex-col w-[30%] items-center justify-center ">
            <img 
            src ={map}
            ...
            className='h-20 w-20'
            />
            <p className='text-greyText text-4xl font-bold mt-2 '>{CurrentEventData[0].loc}</p>
            <p className='text-greyText items-center text-xl font-semibold  '>UPES Bidholi</p>
            </div>
          </div>
        </div>
    </div>
